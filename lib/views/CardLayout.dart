...
class OrderList extends GetView<HomeController> {
  ...
  List<OrderInfo> mList = [
    OrderInfo("Shift Slot", "12pm - 3pm"),
    OrderInfo("From ", "HKBK college road, Manyata ,Nagavara, Blr "),
    OrderInfo("Service Lift", "Y"),
    OrderInfo("To", "Marathalli, Blr")
  ];

  @override
  Widget build(BuildContext context) {
    return Obx(() => ListView.builder(
        itemCount: controller.count.toInt(), itemBuilder: (context, index) {
      return  Obx(() => OrderCard(show: controller.show.toString(),)) ;
    }));
  }


  Widget OrderCard({required String show}) {
    // final String show;
    final orderId = "4213";
        ...
        child: Card(
          ...
          Column(
            ...
            children: [
                    ...
                    children: [
                                ...
                                children: [
                                  Text("Order Id - ", textAlign: TextAlign.left,
                                      style: TextStyle(fontSize: 14,
                                          color: AppColors.color_606060)),
                                  Text(orderId, textAlign: TextAlign.left,
                                      style: TextStyle(fontSize: 14,
                                          color: AppColors.color_606060)),
                                ],
                      ...
                      Expanded(
                          child: Padding(
                              ...
                              child: Row(
                                  children: [
                                    Text("Shift Date", textAlign: TextAlign
                                        .left, style: TextStyle(fontSize: 14,
                                        color: AppColors.color_606060)),
                                    Text(shiftDate, textAlign: TextAlign.left,
                                        style: TextStyle(fontSize: 14,
                                            color: AppColors.color_606060)),
              ...
              if(show == "home") acceptDeclineButtons(),
    ...
    return Container(
        ...
        child: Row(
          ...
          children: [
            Expanded(child:
            ElevatedButton(
              onPressed: () { homeController.updateItem();
              },
              style: ButtonStyle(
